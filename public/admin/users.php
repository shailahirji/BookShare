                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="form-inline" action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="date" name="startdate" class="form-control" id="exampleInputName2" placeholder="Beverly Ackah">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail2">End date</label>
                                <input type="date" name="enddate" class="form-control" id="exampleInputEmail2" placeholder="beverly@hotmail.com">
                            </div>
